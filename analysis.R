...
# Practice set info ---- 
practice.begin("A2", learner="[Xingzhu Liu]", email="[xliu38@uw.edu]")
...
log_attendess_distribution <- log(num_attendees)
log_attendess_distribution <- boxplot(num_attendees)
log_attendess_distribution
